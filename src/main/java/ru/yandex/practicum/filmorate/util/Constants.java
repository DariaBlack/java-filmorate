...
public class Constants {
    ...
    public static final String SQL_SELECT_ALL_GENRES = "SELECT * FROM genre ORDER BY genre_id";
    public static final String SQL_SELECT_GENRE = "SELECT * FROM genre WHERE genre_id = ?";
    public static final String SQL_SELECT_ALL_MPA = "SELECT * FROM rating_mpaa ORDER BY rating_id";
